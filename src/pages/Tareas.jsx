...
export default function Tareas({
  ...
  const hayFiltros =
    filtroMateria || filtroPrioridad || filtroEstado || busqueda;
        ...
        <div className="filter-chips">
          {busqueda && (
            <div
              ...
              style={{ background: "#2d2b4e", color: "#9d96f0" }}
            >
              "{busqueda}"
              <X
                size={11}
          ...
          {filtroPrioridad && (
            <div
              className="filter-chip"
              style={{
                background: PRIORITY[filtroPrioridad].bg,
                color: PRIORITY[filtroPrioridad].color,
              }}
            >
                ...
                <div key={t.id} className="task-row">
                  <div
                    ...
                    onClick={() =>
                      setEstado(
                        t.id,
                        t.estado === "hecha" ? "pendiente" : "hecha",
                      )
                    }
                  >
                    {t.estado === "hecha" && (
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div
                      className={`task-title ${t.estado === "hecha" ? "done" : ""}`}
                    >
                      {t.titulo}
                    </div>
                    <div className="task-meta">
                      ...
                      <span
                        className="badge"
                        style={{
                          background: PRIORITY[t.prioridad]?.bg,
                          color: PRIORITY[t.prioridad]?.color,
                        }}
                      >

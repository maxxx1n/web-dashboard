    ...
    <div style={{ maxWidth: 520, margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", justifyContent: "center", gap: 12, marginBottom: 28 }}>
        <button className="btn-ghost" onClick={reset}
          style={{ background: dark.subtle, border: `1.5px solid ${dark.border}`, color: dark.muted, borderRadius: 12, padding: "12px 24px", fontWeight: 600, cursor: "pointer", fontSize: 14, transition: "all 0.18s" }}>
          Reiniciar
        </button>
        <button className="btn-primary" onClick={toggle}
          style={{ ...btnPrimary, padding: "12px 36px", fontSize: 15, borderRadius: 12, background: running ? `linear-gradient(135deg,#f87171,#e24b4a)` : `linear-gradient(135deg,${cur.color},${cur.color}cc)` }}>

    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .icon-btn { transition: all 0.15s ease; border: none; cursor: pointer; border-radius: 7px; padding: 5px 8px; display: inline-flex; align-items: center; justify-content: center; }
